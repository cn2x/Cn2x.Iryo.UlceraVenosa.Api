...
namespace Beyond.IPO.Domain.Core.Specification
{
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="Beyond.IPO.Domain.Core.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="Beyond.IPO.Domain.Core.Specification.ISpecification{TEntity}"/></returns>
