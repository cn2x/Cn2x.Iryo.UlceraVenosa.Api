...
namespace Cn2x.Iryo.UlceraVenosa.Infrastructure.Migrations
{
    ...
    [Migration("20250707215449_CorrigirRelacionamentoImagens")]
    partial class CorrigirRelacionamentoImagens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cn2x.Iryo.UlceraVenosa.Domain.Entities.ImagemUlcera", b =>
                {
                    ...
                    b.Property<Guid?>("avaliacao_ulcera_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("avaliacao_ulcera_id");
            ...
            modelBuilder.Entity("Cn2x.Iryo.UlceraVenosa.Domain.Entities.ImagemUlcera", b =>
                {
                    ...
                    b.HasOne("Cn2x.Iryo.UlceraVenosa.Domain.Entities.AvaliacaoUlcera", null)
                        .WithMany("Imagens")
                        .HasForeignKey("avaliacao_ulcera_id")
                        .OnDelete(DeleteBehavior.Cascade);
